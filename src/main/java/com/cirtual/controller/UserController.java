...
public class UserController {
	 ...
	 * 
	 * @param User id for which details are required.
	 * @return The User details generated by the toString() method of the User class.
	 */
	 ...
	 * The @RequestBody contains field values of the User class which is validated.
	 * A pre-check is done to see if the User is already registered. User email which
	 * need to be unique among the users is used for this check.
	 * 
	 * @param user class member data which needs to be used for the User object population.
	 * @param bindingResult generated after validation of the user input.
	 ...
	 * only update few of the details after registration: firstName and lastName.
	 * Other details cannot be modified once created. Authentication is done to make
	 * sure that the request sender is same user as the profile under update.
	 * 
	 * @param id of the user which needs to be updated
	 * @param user: new user details which will update the existing details.
	 * @param bindingResult generated after validation of the user input.
